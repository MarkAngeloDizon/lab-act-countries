    ...
    if (!country) {
        return (
            <div className="max-w-md mx-auto py-10 text-center space-y-4">
                ...
                <p>No country with code "{countryCode}" exists in our data.
                </p>Lab Activity 08: Country Detail Pages with NavLink & useNavigate 4
    ...
    return (
        <div className="max-w-md mx-auto card bg-base-100 shadow p-6 text-center space-y-3">
            ...
            <div className="flex gap-2 justify-center pt-2">
                ...
                <button className="btn btn-primary" onClick={handleRandom}> Random Country </button>
            </div>
        </div>
    );
};
